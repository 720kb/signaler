...
(function (global, factory) {
  ...
  typeof define === 'function' && define.amd ? define('angular-signaler', factory) :
  (factory());
  ...
  (function withAngular(angular, Signaler) {
    ...
    angular.module('720kb.signaler', []).provider('Signaler', function providerFunction() {
      ...
      return {
        ...
        '$get': ['$rootScope', '$window', '$log', function instantiateProvider($rootScope, $window, $log) {
...
//# sourceMappingURL=angular-signaler.js.map