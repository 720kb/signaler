{ LESSOPEN: '| /usr/bin/lesspipe %s',
  ...
  npm_lifecycle_script: './tasks/banner | xargs -0 -I banner uglifyjs src/js/signaler.js src/angular/signaler.js --preamble banner -c -m --screw-ie8 -p relative --source-map dist/signaler-angular.min.js.map -o dist/signaler-angular.min.js',
  ...
  npm_config_access: '',
  npm_config_save: '',
  npm_lifecycle_event: 'ng-min',
  rvm_prefix: '/home/dario',
  GDMSESSION: 'ubuntu',
  npm_config_argv: '{"remain":[],"cooked":["run-script","ng-min"],"original":["run-script","ng-min"]}',
